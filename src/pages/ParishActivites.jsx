        ...
        >
          <div className="space-y-6 lg:space-y-14">
            {[
              ...
              {
                title: "CONFESSIONS",
                content: "– Every Saturday Confessions: 5:00 PM to 6:00 PM and Also available on request",
                delay: 600
              },
              {
                title: "CATECHISM",
                content: <>
                  <p>Catechism class is done on Sundays after the second mass. For those preparing for first communion, the catechumen should be 8 years or more. For those preparing for confirmation, the catechumen should be 12 years and above.</p>
                  <p className="mt-2">For more information kindly contact the parish office.</p>
                </>,
                delay: 800
              },
              {
                title: "VISITATION OF THE SICK & HOMEBOUND",
                content: "Kindly inform the Parish Office of anyone who is sick or unable to attend Mass and arrangements will be made for them to receive Holy Communion at home.",
                delay: 1000
              }
            ].map((item, index) => (
              <div
                ...
                className="hover:-translate-y-1 transition-all duration-300 backdrop-blur-md bg-white/30 p-4 lg:p-6 rounded-lg shadow-lg hover:bg-white/40 max-w-md mx-auto lg:mx-0 w-full"
              >
                <h2 className="text-red-600 font-bold text-base lg:text-lg mb-2">{item.title}</h2>
                <div className="text-white text-sm lg:text-base leading-relaxed">{item.content}</div>
              </div>
            ))}
          </div>
        </section>
            ...
            {[
              {
                ...
                content: "Infant baptism takes place every third Saturday of the month. Infant baptism is for babies to age 7. Teachings are done Thursday before the day of the infant baptism. Parents and godparents must attend. For more information kindly call the parish office",
                delay: 200
              },
              {
                title: "MARRIAGE COUNSELLING & MARRIAGE",
                content: "Marriage counseling is done by a team of experts trained by the church. It is group counseling. Marriage counseling is a six months period. Those who are preparing for the sacrament of Holy matrimony must always have that in mind. You can only choose a date after you have gone through the counseling. To qualify to register for the counseling you must have been a parishioner for six months consistently and beyond. For more information kindly contact the priest.",
                delay: 400
              },
              {
                title: "ADORATION",
                content: "– First Friday of the month Adoration and Mass 6:30 P.M. Our adoration Chapel is open for personal prayer 24/7",
                delay: 600
              }
            ].map((item, index) => (
              <div
              ...
              >
                <h2 className="text-red-600 font-bold text-base lg:text-lg mb-2">{item.title}</h2>
                <p className="text-white text-sm lg:text-base leading-relaxed">{item.content}</p>
              </div>
            ))}
          </div>
        </section>
